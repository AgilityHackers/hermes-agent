...
export const en: Translations = {
  ...
  assistant: {
    ...
    mcpSetup: {
      ...
      dismiss: 'Dismiss',
      declined: 'Declined',
      declinedOne: server => `Declined ${server}`,
      connected: server => `Connected ${server}`,
      skipped: server => `Skipped ${server}`,
      failed: server => `Could not connect ${server}`,
      ...
      trustCommunityTip:
        'Nobody has verified who runs this endpoint — the publisher’s registry name does not match the domain it connects to. Check the address before connecting.',
